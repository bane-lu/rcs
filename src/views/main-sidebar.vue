  ...
  <aside class="site-sidebar" :class="'site-sidebar--' + sidebarLayoutSkin">
    <div class="site-sidebar__inner">
      <el-menu
        ...
        <!-- <el-menu-item index="versionmanage" @click="$router.push({ name: 'versionmanage' })">
          <i class="el-icon-document"></i>
          <span slot="title">版本管理</span>
        </el-menu-item>

        <el-menu-item index="urlmanage" @click="$router.push({ name: 'urlmanage' })">
          <i class="el-icon-tickets"></i>
          <span slot="title">url管理</span>
        </el-menu-item> -->
      </el-menu>
    </div>
  </aside>
