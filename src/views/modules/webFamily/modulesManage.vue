  ...
  <div id="webFamily">
    <el-form :inline="true">
      <el-form-item label="方案选择">
        <el-select v-model="form.methodVal" placeholder="请选择">
            <el-option v-for="item in method" :label="item.provinceName" :value="item.provinceName"  :key="item.provinceId"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="reset">排序</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      <el-table-column type="index" :index="transforIndex" header-align="center" align="center" label="序号" width="80">
      </el-table-column>
      <el-table-column prop="mobile" header-align="center" align="center" width="120" label="模块名称">
      </el-table-column>
      <el-table-column prop="app" header-align="center" align="center" width="180" label="APP">
      </el-table-column>
      <el-table-column prop="desc" header-align="center" align="center" label="创建时间" width="290">
        <template slot-scope="props">
          <span v-text="props.row.startDate +' — '+ props.row.endDate"></span>
        </template>
      </el-table-column>
      <el-table-column prop="desc" header-align="center" align="center" :show-overflow-tooltip="true" label="描述" width="200">
        <template slot-scope="props">
