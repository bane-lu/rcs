  ...
  <div>
    ...
    <el-row :gutter="24">
      ...
      <el-col :span="8"><div class="grid-content bg-purple">
          ...
          <el-button type="danger" v-if="isAuth('manager:url:delete')" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </div></el-col>
    </el-row>
    <!-- 分页 -->
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="props">
          <el-button type="primary" v-if="isAuth('manager:url:update')" size="mini" @click="addOrUpdateHandle(props.row)">编辑</el-button>
          <el-button type="danger" v-if="isAuth('manager:url:delete')" size="mini" @click="deleteHandle(props.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
